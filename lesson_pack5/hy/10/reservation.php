...
$_conf['mail_sub'] = "And Golf「スイング改造プログラム」体験レッスン 予約フォーム";		// 管理者メールsub
$_conf['mail_kakunin_from'] = "info@andgolf.jp";			// 確認メールfrom
$_conf['mail_kakunin_fromname'] = "アンドゴルフ海浜幕張店";		// 確認メールfromname
$_conf['mail_kakunin_sub'] = "「スイング改造プログラム」体験レッスンのご予約を受け付けました";	// 確認メールsub
...
このメールを受信された1営業日以内に、
「体験レッスン日時確定のお知らせ」メールを送信させていただきますので、しばらくお待ちください。
...
体験レッスンをご予約いただいた方に、
Web視聴版「5日間スイング改造プログラム（全5話）」を
期間限定で無料公開しております。

下記の【アンドゴルフ無料メルマガ】にメールアドレスを登録し、
Web視聴版「5日間スイング改造プログラム（全5話）」をお受け取りください。

【アンドゴルフ無料メルマガ】
https://variation-ex.com/fx/5daymail （※レッスン動画は1日1本ずつ配信されます。）
